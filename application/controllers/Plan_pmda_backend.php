...
class Plan_pmda_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($plan_pmda as $pdf) {
            $pdf->pdf = $this->plan_pmda_model->list_all_pdf($pdf->plan_pmda_id);
        }
        foreach ($plan_pmda as $doc) {
            $doc->doc = $this->plan_pmda_model->list_all_doc($doc->plan_pmda_id);
        }
    ...
    public function del_pdf($pdf_id)
    {
        ...
        $this->plan_pmda_model->del_pdf($pdf_id);
    ...
    public function del_doc($doc_id)
    {
        ...
        $this->plan_pmda_model->del_doc($doc_id);
    ...
    public function del_plan_pmda($plan_pmda_id)
    {
        ...
        $this->plan_pmda_model->del_plan_pmda_doc($plan_pmda_id);
