...
class Pbsv_ems_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($pbsv_ems as $pdf) {
            $pdf->pdf = $this->pbsv_ems_model->list_all_pdf($pdf->pbsv_ems_id);
        }
        foreach ($pbsv_ems as $doc) {
            $doc->doc = $this->pbsv_ems_model->list_all_doc($doc->pbsv_ems_id);
        }
    ...
    public function del_pdf($pdf_id)
    {
        ...
        $this->pbsv_ems_model->del_pdf($pdf_id);
    ...
    public function del_doc($doc_id)
    {
        ...
        $this->pbsv_ems_model->del_doc($doc_id);
    ...
    public function del_pbsv_ems($pbsv_ems_id)
    {
        ...
        $this->pbsv_ems_model->del_pbsv_ems_doc($pbsv_ems_id);
