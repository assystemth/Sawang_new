<style>
    ...
    .bg-header {
        /* The image used */
        background-image: url('<?php echo base_url("docs/intranet/s.navbar-intranet3.png"); ?>');
    ...
    .welcome {
        background-image: url('<?php echo base_url("docs/intranet/s.welcome2.jpg"); ?>');
        background-size: contain;
        background-repeat: no-repeat;
    ...
    .footer {
        background-image: url('<?php echo base_url("docs/intranet/s.bg-intra-footer.png"); ?>');
        background-size: contain;
        background-repeat: no-repeat;
        width: 100vw;
        height: 27vh;
