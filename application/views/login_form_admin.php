    ...
    <div class="bg">
        ...
        <form id="reCAPTCHA3" action="<?php echo site_url('user/check2'); ?>" method="post">
            ...
            <div style="margin-left: 10%;">
                ...
                <button type="submit" class="loginBtn g-recaptcha" id="loginBtn" data-action='submit' data-callback='onSubmit' data-sitekey="6LcfiLYpAAAAAI7_U3nkRRxKF7e8B_fwOGqi7g6x">เข้าสู่ระบบ</button>
            </div>
