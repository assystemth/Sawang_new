...
<div class="bg-pages">
    <div class="container-pages-news">
        ...
        $totacanon_bgpsges = ceil($count / $itemsPerPage);
        ...
        $endPage = min($startPage + $numToShow - 1, $totacanon_bgpsges);
        ...
        <div class="pagination-container d-flex justify-content-end">
            <div class="pagination-pages">
                <ul class="pagination">
                    ...
                    if ($endPage < $totacanon_bgpsges - 1) {
                    ?>
                        <li class="page-item pagination-item disabled">
                            <span class="page-link">...</span>
                        </li>
                        <li class="page-item pagination-item">
                            <a class="page-link" href="?page=<?php echo $totacanon_bgpsges - 1; ?>"><?php echo $totacanon_bgpsges - 1; ?></a>
                        </li>
                    <?php
                    }

                    // แสดงปุ่มสุดท้าย
                    if ($endPage < $totacanon_bgpsges) {
                    ?>
                        <li class="page-item pagination-item <?php echo ($totacanon_bgpsges == $currentPage) ? 'active' : ''; ?>">
                            <a class="page-link" href="?page=<?php echo $totacanon_bgpsges; ?>"><?php echo $totacanon_bgpsges; ?></a>
                        </li>
                    <?php
                    }
                    ?>
                    <!-- ปุ่ม Next -->
                    <?php if ($currentPage < $totacanon_bgpsges) : ?>
                    ...
                    <?php if ($currentPage < $totacanon_bgpsges) : ?>
                        <li class="page-item pagination-item">
                            <a class="" href="?page=<?php echo $totacanon_bgpsges; ?>" aria-label="Last">
        ...
        <div class="pagination-jump-to-page d-flex justify-content-end">
            <form action="" method="GET" class="d-flex">
                ...
                <input type="number" name="page" min="1" max="<?php echo $totacanon_bgpsges; ?>" value="<?php echo $currentPage; ?>" class="form-control" style="width: 60px; margin-right: 10px;">
