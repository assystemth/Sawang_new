    ...
    <div class="bg-pages">
        <div class="container-pages-detail">
            ...
            <div class="pages-content break-word mt-2">
                ...
                <br>
                <?php 
                    if($rsData->p_sopopip_link != "") {
                        echo '<span class="font-pages-content-detail">ลิ้งค์เพิ่มเติม:</span>&nbsp;<a class="font-26" href="' . $rsData->p_sopopip_link . '" target="_blank">' . $rsData->p_sopopip_link . '</a>';
                    }
                ?>
                <br>
                <?php if (!empty($rsDoc)) { ?>
                    ...
                    // ดึงข้อมูลของไฟล์
                    $fileInfo = pathinfo($doc->p_sopopip_file_doc);
