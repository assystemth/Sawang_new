        ...
        <div class="bg-pages-in-web " style="padding-top:80px;">
            ...
            <div class="scrollable-container">
                <div class="page-content-travel">
                    ...
                    <span class="font-page-detail-time-img"><svg xmlns="http://www.w3.org/2000/svg" width="13"
                            height="14" fill="currentColor" class="bi bi-calendar-minus-fill" viewBox="0 0 16 16">
                            <path
                    ...
                    <span class="font-page-detail-content-img">ตำแหน่งที่ตั้ง</span> : <span
                        class="font-page-detail-content-img underline"><?= $rsTravel->travel_location; ?> <a
                            ...
                            href="https://www.google.com/maps?q=<?= $rsTravel->travel_lat; ?>,<?= $rsTravel->travel_long; ?>">Google
                            Map</a></span>
                    <br>
                    ...
                    <div class="row mt-5">
                        <?php foreach ($rsImg as $img) { ?>
                            <div class="col-3 mb-3">
                                <a href="<?php echo base_url('docs/img/' . $img->travel_img_img); ?>"
                                    data-lightbox="image-1" data-title="My caption">
                                    <img class="rounded-all"
                                        src="<?php echo base_url('docs/img/' . $img->travel_img_img); ?>" width="209px"
                                        height="202px">
                                </a>
                            </div>
                        <?php } ?>
                ...
                <div class="col-6">
                    <div class="margin-top-delete-travel d-flex justify-content-end">
                        <a href="<?php echo site_url('Pages/travel'); ?>"><img
                                src="<?php echo base_url("docs/s.btn-back.png"); ?>"></a>
                    </div>
                </div>
            </div>
        </div>
