            ...
            <div class="row mt-5">
                <?php foreach ($rsImg as $img) { ?>
                    <div class="col-2 mb-3 mx-4">
                        <a href="<?php echo base_url('docs/img/' . $img->travel_img_img); ?>" data-lightbox="image-1" data-title="image-1">
                            <img class="rounded-all" src="<?php echo base_url('docs/img/' . $img->travel_img_img); ?>" width="258px" height="146px">
                        </a>
                    </div>
                <?php } ?>
            </div>
