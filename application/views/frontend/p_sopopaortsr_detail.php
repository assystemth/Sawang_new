<div class="bg-pages">
    <div class="container-pages-detail">
        ...
        <div class="head-pages-three">
                <span class="font-pages-head-long">รายงานสรุปผลการจัดซื้อ<br>จัดจ้างหรือการจัดหาพัสดุ</span>
            </div>
        </div>
        <div class="row">
            <div class="path1-1">
            ...
            <div class="scrollable-container-news">
                ...
                <?php foreach ($rsImg as $img) { ?>
                    <div class="col-3 mb-3">
                        <img class="rounded-all" src="<?php echo base_url('docs/img/' . $img->p_sopopaortsr_img_img); ?>" width="950px" height="100%">
                    </div>
                <?php } ?>
