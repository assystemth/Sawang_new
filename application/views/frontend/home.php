    ...
    <div class="row" style="margin-top: -80px;">
        <div class="col-6 content-banner">
            ...
            <div class="banner-cartoon">
                <div style="margin-left: 200px; padding: 55px; text-align: center;">
                        ...
                        <div class="banner-button-green" style="margin-top: 80px;">
                            <div class="row">
                                <div class="col-7" style="padding: 10px 10px 0px 50px;">
                                    <span
                                        class="font-banner-button-green">การประเมินคุณธรรม<br>&nbsp;&nbsp;และความโปร่งใส</span>
                                </div>
...
<div class="bg-activity2">
    <div class="d-flex justify-content-center" style="padding-top: 3%; color: #fff;">
        <span class="font-header-home">กิจกรรม</span>
    </div>
            ...
            <div class="card-activity col-4 mx-4" style="margin-top: 40px;">
                <?php if (!empty($activity->activity_img)): ?>
                    <a href="<?= site_url('pages/activity_detail/' . $activity->activity_id); ?>">
                        <img src="<?php echo base_url('docs/img/' . $activity->activity_img); ?>" width="245px" height="182px"
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <span class="text-news"><img
                                            src="docs/s.icon-news.png">&nbsp;&nbsp;<?= strip_tags($news->news_name); ?></span>
                                </div>
                                <div class="col-2">
                                    <div class="row">
                                        <div class="col-10">
            ...
            <div id="tabtwo2" class="tab-content-two">
                ...
                <div class="content-news-detail">
                    <a href="<?php echo site_url('Pages/canon_chh'); ?>">
                        <span class="text-news"><img
                                src="docs/s.icon-news.png">&nbsp;&nbsp;ข้อบัญญัติการควบคุมกิจการที่เป็นอันตรายต่อสุขภาพ</span>
                    </a>
                </div>
                <div class="content-news-detail">
                    <a href="<?php echo site_url('Pages/canon_ritw'); ?>">
                        <span class="text-news"><img
                                src="docs/s.icon-news.png">&nbsp;&nbsp;ข้อบัญญัติการติดตั้งระบบบำบัดน้ำเสียในอาคาร</span>
                    </a>
                </div>
                <div class="content-news-detail">
                ...
                <div class="content-news-detail">
                    <a href="<?php echo site_url('Pages/canon_rmwp'); ?>">
                        <span class="text-news"><img
                                src="docs/s.icon-news.png">&nbsp;&nbsp;ข้อบัญญัติการจัดการสิ่งปฏิกูลและมูลฝอย</span>
                    </a>
                </div>
                <div class="content-news-detail">
                    <a href="<?php echo site_url('Pages/canon_rcsp'); ?>">
                        <span class="text-news"><img
                                src="docs/s.icon-news.png">&nbsp;&nbsp;ข้อบัญญัติหลักเกณฑ์การคัดมูลฝอย</span>
                    </a>
                </div>
                <div class="content-news-detail">
                    <a href="<?php echo site_url('Pages/canon_rcp'); ?>">
                        <span class="text-news"><img
                                src="docs/s.icon-news.png">&nbsp;&nbsp;ข้อบัญญัติการควบคุมการเลี้ยงหรือปล่อยสุนัขและแมว</span>
                    </a>
                </div>
            </div>
                    ...
                    <div class="content-news-detail">
                        <a href="<?php echo site_url('Pages/order_detail/' . $gw->order_id); ?>">
                            <div class="row">
                                <div class="col-10">
                                    <span class="text-news"><img
                                            src="docs/s.icon-news.png">&nbsp;&nbsp;<?= strip_tags($gw->order_name); ?></span>
                                </div>
                                <div class="col-2">
                                    <div class="row">
                                        <div class="col-10">
                    ...
                    <div class="content-news-detail">
                        <a href="<?php echo site_url('Pages/announce_detail/' . $gw->announce_id); ?>">
                            <div class="row">
                                <div class="col-10">
                                    <span class="text-news"><img
                                            src="docs/s.icon-news.png">&nbsp;&nbsp;<?= strip_tags($gw->announce_name); ?></span>
                                </div>
                                <div class="col-2">
                                    <div class="row">
                                        <div class="col-10">
                    ...
                    <div class="content-news-detail">
                        <a href="<?php echo site_url('Pages/procurement_detail/' . $pcm->procurement_id); ?>">
                            <div class="row">
                                <div class="col-10">
                                    <span class="text-news"><img
                                            src="docs/s.icon-news.png">&nbsp;&nbsp;<?= strip_tags($pcm->procurement_name); ?></span>
                                </div>
                                <div class="col-2">
                                    <div class="row">
                                        <div class="col-10">
                    ...
                    <div class="content-news-detail">
                        <a href="<?php echo site_url('Pages/p_reb_detail/' . $anou->p_reb_id); ?>">
                            <div class="row">
                                <div class="col-10">
                                    <span class="text-news"><img
                                            src="docs/s.icon-news.png">&nbsp;&nbsp;<?= strip_tags($anou->p_reb_name); ?></span>
                                </div>
                                <div class="col-2">
                                    <div class="row">
                                        <div class="col-10">
                    ...
                    <div class="content-news-detail">
                        <a href="<?php echo site_url('Pages/p_rpo_detail/' . $anou->p_rpo_id); ?>">
                            <div class="row">
                                <div class="col-10">
                                    <span class="text-news"><img
                                            src="docs/s.icon-news.png">&nbsp;&nbsp;<?= strip_tags($anou->p_rpo_name); ?></span>
                                </div>
                                <div class="col-2">
                                    <div class="row">
                                        <div class="col-10">
...
<div class="bg-otop">
    <div class="d-flex justify-content-center" style="padding-top: 3%; color: #fff;">
        <div class="otop-box">
            <span class="font-header-home d-flex justify-content-center">ผลิตภัณฑ์ชุมชน</span>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-center" style="padding-top: 3%; color: #fff;">
        <div class="otop-box">
            <span class="font-header-home d-flex justify-content-center">สถานที่ท่องเที่ยว</span>
        </div>
    </div>
            ...
            <?php foreach ($qTravel as $travel) { ?>
                <div class="text-center">
                    <a href="<?php echo site_url('Pages/travel_detail/' . $travel->travel_id); ?>">
                        <img src="<?php echo base_url('docs/img/' . $travel->travel_img); ?>" width="239px" height="239px"
                    ...
                    <div class="d-flex justify-content-center">
                        <a class="underline" href="<?php echo site_url('Pages/travel_detail/' . $travel->travel_id); ?>">
                            ...
                            ?>
                            <img src="<?php echo base_url('docs/' . $imageName); ?>"
                                alt="Image for ID <?php echo $travel->travel_id; ?>">
                        </a>
                    </div>
                </div>
            <?php } ?>
