               ...
               <div class="popup-content">
                  ...
                  <form action="<?php echo site_url('intra_discipline/add'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                     ...
                     <div class="form-group row container">
                        ...
                        <div class="col-sm-6">
                           <input type="file" name="intra_discipline_pdf" class="form-control" accept=".pdf, .xls, .xlsx, .doc, .docx, .ppt, .pptx" required>
               ...
               ?>
                  <tr>
                     <td class="font-20 limit-font-one " style="padding-left: 30px;">
                        <?php if (strpos($rs->intra_discipline_pdf, '.pdf') !== false) : ?>
                           <!-- ถ้ามี .pdf อยู่ในชื่อไฟล์ -->
                           <a class="underline black" href="<?= site_url('intra_discipline/discipline_detail/' . $rs->intra_discipline_id); ?>">
                              <img src="<?php echo base_url($iconImage); ?>" width="30"> &nbsp;<?= $rs->intra_discipline_name; ?>
                           </a>
                        <?php else : ?>
                           <!-- ถ้าไม่มี .pdf อยู่ในชื่อไฟล์ -->
                           <a class="underline black" onclick="downloadFile(event, <?= $rs->intra_discipline_id; ?>)" href="<?= base_url('docs/intranet/file/' . $rs->intra_discipline_pdf); ?>" download>
                              <img src="<?php echo base_url($iconImage); ?>" width="30"> &nbsp;<?= $rs->intra_discipline_name; ?>
                           </a>
                           <script>
                     ...
                     <td class="font-20 limit-font-one" align="center"><?= $rs->intra_discipline_by ?></td>
                     <td class="font-20" align="center">
                        <?php if ($_SESSION['m_level'] == 1 || $_SESSION['m_level'] == 2 || $_SESSION['m_fname'] == $rsedit->intra_discipline_by) : ?>
                           <a class="red" href="#" role="button" onclick="confirmDelete(<?= $rs->intra_discipline_id; ?>);"><i class="bi bi-trash fa-lg"></i></a>
                           <script>
                     ...
                     <td class="font-20" align="center">
                        <a onclick="downloadFile(event, <?= $rs->intra_discipline_id; ?>)" href="<?= base_url('docs/intranet/file/' . $rs->intra_discipline_pdf); ?>" download>
