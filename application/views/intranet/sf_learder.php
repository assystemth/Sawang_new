...
<div id="popupInsert" class="popup">
    <div class="popup-content">
        ...
        <form action="<?php echo site_url('Intra_share_file/add_sf_learder'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            <br>
            ...
            <div class="form-group row container">
                ...
                <div class="col-sm-6">
                    <input type="file" name="intra_sf_learder_pdf" class="form-control" accept=".pdf, .docx, .xls, .doc" required>
            ...
            <div class="form-group row container">
                ...
                <div class="col-sm-5">
                    ...
                    <a class="btn btn-danger" href="<?= site_url('Intra_share_file/sf_learder'); ?>" role="button">ยกเลิก</a>
                </div>
            </div>
        </form>
    </div>
...
<div class="flex-item-right-share-file">
    <div class="row">
        <div class="col-6 mt-5">
            ...
            <span class="font-folder-detail mx-3">ผู้นำชุมชน</span>
        </div>
        <div class="col-6 mt-5">
            ...
            ?>
                <div class="col-sm-6 mt-2">
                    <span class="black font-20 limit-font-one">
                        <a class="underline" href="<?php echo base_url('docs/intranet/file/' . $rs->intra_sf_learder_pdf); ?>" download>
                            <img src="<?php echo base_url($iconImage); ?>" width="25">
                            <?= $rs->intra_sf_learder_name; ?>
                        </a>
                    </span>
                </div>
                ...
                <div class="col-sm-2 mt-2">
                    <span class="font-18"><?= $rs->intra_sf_learder_by; ?></span>
                </div>
                <div class="col-sm-2 mt-2 white">

                <?php if ($_SESSION['m_level'] == 1 || $_SESSION['m_level'] == 2 || $_SESSION['m_fname'] == $rs->intra_sf_learder_by) : ?>
                    <div class="d-flex justify-content-end">
                        <a href="#" class="btn btn-danger btn-sm" role="button" onclick="confirmDelete(<?= $rs->intra_sf_learder_id; ?>);"><i class="bi bi-trash fa-lg mx-2"></i>ลบ</a>
                    </div>
                    <?php endif; ?>
                        ...
                        function confirmDelete(intra_sf_learder_id) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = "<?= site_url('Intra_share_file/del_sf_learder/'); ?>" + intra_sf_learder_id;
                                }
                            });
                        }
                    </script>
