        ...
        <div class="main-content">
            <div class="divcontent">
                <div class="bg-complain-all mt-4">
                    <span class="font-head-pdf"><?= $rsedit->intra_sf_learder_name; ?></span>
                    <div class="row mt-4">
                        <div class="col-sm-9 font-download-pdf mt-2">จำนวนดาวน์โหลด <?= $rsedit->intra_sf_learder_download; ?> ครั้ง</div>
                        <div class="col-sm-3 d-flex justify-content-end">
                            <?php if ($_SESSION['m_level'] == 1 || $_SESSION['m_level'] == 2 || $_SESSION['m_fname'] == $rsedit->intra_sf_learder_by) : ?>
                                <a class="btn btn-danger" href="#" role="button" onclick="confirmDelete(<?= $rsedit->intra_sf_learder_id; ?>);"><i class="bi bi-trash fa-lg"></i>ลบ</a>
                                <script>
                            ...
                            <?php endif; ?>
                            &nbsp;
                            <a class="btn btn-download" onclick="downloadFile(event, <?= $rsedit->intra_sf_learder_id; ?>)" href="<?= base_url('docs/intranet/file/' . $rsedit->intra_sf_learder_pdf); ?>" download>
                    ...
                    <div class="blog-text mt-3 mb-5">
                        <object data="<?= base_url('docs/intranet/file/' . $rsedit->intra_sf_learder_pdf); ?>" type="application/pdf" width="100%" height="1500px"></object>
                    </div>
                    <!-- <div class="d-flex justify-content-end">
                        <a href="<?= site_url('intra_sf_learder'); ?>">
