...
<ul class="navbar-nav bg-gradient-custom sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('System_admin'); ?>">
        ...
        <div class="sidebar-brand-text mx-3" style="color: #000;">อบต. สว่าง </div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseseven" class="collapse" aria-labelledby="headingseven" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo site_url('P_rpobuy_backend'); ?>">รายการจัดซื้อจัดจ้าง<br>หรือการจัดหาพัสดุ</a>
    ...
    <li class="nav-item">
        <a class="nav-link" style="color: #000;" href="<?php echo site_url('Laws_backend'); ?>">
            <img src="<?= base_url('docs/btn-bend-back12.png'); ?>">
            <span>กฏหมาย</span></a>
    </li>
    ...
    <!-- <li class="nav-item">
                <a class="nav-link collapsed" style="color: #000;" data-toggle="collapse" aria-expanded="true" href="javascript:void(0);" onclick="toggleCollapse('collapsenine')">
                    <img src="<?= base_url('docs/btn-bend-back13.png'); ?>">
                    <span>รายงาน</span>
                </a>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <ul id="menuList" style="display: none;">
                ...
                <a href="<?php echo site_url('Important_day_backend'); ?>" class="link">
                ...
                <a href="<?php echo site_url('Site_map_backend'); ?>" class="link">
                    ...
                    <li class="hide">
                        <span>ข้อมูลโครงสร้างเว็บไซต์</span>
                    </li>
                </a>
                ...
                <a href="<?php echo site_url('P_education_backend'); ?>" class="link">
                    ...
                    <li class="hide">
                        <span>ข้อมูลกองสวัสดิการสังคม</span>
                    </li>
                </a>
                ...
                <a href="<?php echo site_url('Canon_chh_backend'); ?>" class="link">
                    ...
                    <li class="hide">
                        <span>ข้อบัญญัติการควบคุมกิจการที่เป็นอันตรายต่อสุขภาพ</span>
                    </li>
                </a>
                ...
                <a href="<?php echo site_url('Canon_ritw_backend'); ?>" class="link">
                    ...
                    <li class="hide">
                        <span>ข้อบัญญัติการติดตั้งระบบบำบัดน้ำเสียในอาคาร</span>
                    </li>
                </a>
                ...
                <a href="<?php echo site_url('Canon_rmwp_backend'); ?>" class="link">
                    ...
                    <li class="hide">
                        <span>ข้อบัญญัติการจัดการสิ่งปฏิกูลและมูลฝอย</span>
                    </li>
                </a>
                ...
                <a href="<?php echo site_url('Canon_rcsp_backend'); ?>" class="link">
                    ...
                    <li class="hide">
                        <span>ข้อบัญญัติหลักเกณฑ์การคัดขยะมูลฝอย</span>
                    </li>
                </a>
                ...
                <a href="<?php echo site_url('Canon_rcp_backend'); ?>" class="link">
                    ...
                    <li class="hide">
                        <span>ข้อบัญญัติการควบคุมการเลี้ยงหรือปล่อยสุนัขและแมว</span>
                    </li>
                </a>
                ...
                <a href="<?php echo site_url('Pbsv_ahs_backend'); ?>" class="link">
                    ...
                    <li class="hide">
                        <span>หลักประกันสุขภาพตำบล</span>
                    </li>
                </a>
                ...
                <li class="hide">
                    <a href="<?php echo site_url('operation_pm'); ?>" class="link">
                ...
                <a href="<?php echo site_url('P_sopopip_backend'); ?>" class="link">
                    <li class="hide">
                        <span>รายงานความก้าวหน้าการจัดซื้อจัดจ้างหรือจัดหาพัสดุ</span>
                    </li>
                </a>
                <a href="<?php echo site_url('P_sopopaortsr_backend'); ?>" class="link">
                    <li class="hide">
                        <span>รายงานสรุปผลการจัดซื้อจัดจ้างหรือการจัดหาพัสดุ</span>
                    </li>
                </a>
