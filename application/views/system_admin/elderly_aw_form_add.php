<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('elderly_aw_backend/add_elderly_aw'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group row">
                    <div class="col-sm-4 control-label">เลขประจำตัวประชาชนผู้มีสิทธิ</div>
                    <div class="col-sm-8">
                        <input type="text" name="elderly_aw_id_num_eligible" class="form-control" pattern="\d{13}" title="กรุณากรอกเลขประจำตัวประชาชนผู้มีสิทธิเป็นตัวเลข 13 หลัก">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="elderly_aw_name_eligible" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="elderly_aw_id_num_owner" class="form-control" pattern="\d{13}" title="กรุณากรอกเลขประจำตัวประชาชนเจ้าของบัญชีเป็นตัวเลข 13 หลัก">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="elderly_aw_name_owner" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="elderly_aw_agency" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="elderly_aw_bank" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="elderly_aw_type_payment" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="elderly_aw_bank_num" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="elderly_aw_note" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
