...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-black">จัดการข้อมูลรคู่มือการปฏิบัติงาน</h6>
    </div>
    <div class="card-body">
                        ...
                        <tr role="row">
                            ...
                            <td>
                                <?php if (!empty($rs->guide_work_img)) : ?>
                                    <img src="<?php echo base_url('docs/img/' . $rs->guide_work_img); ?>" width="120px" height="80px">
                                <?php else : ?>
                            ...
                            <td>
                                <?php foreach ($rs->pdf as $pdf) : ?>
                                    <a class="btn btn-primary btn-sm mt-1" href="<?php echo base_url('docs/file/' . $pdf->guide_work_pdf_pdf); ?>" target="_blank">ดูไฟล์เดิม!</a>
                                <?php endforeach; ?>
                                <br>
                                <?php foreach ($rs->doc as $doc) : ?>
                                    <a class="btn btn-info btn-sm mt-1" href="<?php echo base_url('docs/file/' . $doc->guide_work_file_doc); ?>" target="_blank">ดูไฟล์เดิม!</a>
                                <?php endforeach; ?>
                            </td>
                            ...
                            <td>
                                ...
                                <script>
                                    function update_guide_work_status<?= $rs->guide_work_id; ?>() {
                                        ...
                                        const newStatus = document.getElementById('flexSwitchCheck<?= $rs->guide_work_id; ?>').checked ? 'show' : 'hide';
