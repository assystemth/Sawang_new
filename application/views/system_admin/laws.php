...
<div id="popupInsert" class="popup">
    <div class="popup-content">
        <h4>เพิ่มข้อมูลกฏหมาย : <?= $query->laws_topic_topic; ?></h4>
        <form action="<?php echo site_url('Laws_backend/add_laws'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-black">จัดการข้อมูลกฏหมาย : <?= $query->laws_topic_topic; ?></h6>
    </div>
    <div class="card-body">
