<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>แก้ไขข้อมูลชื่อหัวข้อกฏหมาย</h4>
            <form action=" <?php echo site_url('laws_backend/edit_topic/' . $rsedit->laws_topic_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
