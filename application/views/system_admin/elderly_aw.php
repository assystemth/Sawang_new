    ...
    <div id="popupInsert" class="popup">
        <div class="popup-content">
            ...
            <form method="post" action="<?php echo base_url() ?>Elderly_aw_backend/importcsv" enctype="multipart/form-data">
            ...
            <!-- <form action="<?php echo site_url('Elderly_aw_backend/add_csv_data_to_database'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
    ...
    <a class="btn btn-info" role="button" href="<?= base_url('docs/การเพิ่มข้อมูลเบี้ยผู้สูงอายุ/ผู้พิการแบบไฟล์Excel.rar'); ?>" download>
